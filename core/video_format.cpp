...
{									   
	DEFINE_VIDEOFORMATDESC(video_format::pal		,720,  576,  1024, 576,  field_mode::upper,			25000,		1000,	boost::assign::list_of(1920),							L"PAL"), 
	...
	DEFINE_VIDEOFORMATDESC(video_format::x576p2500	,1024, 576,  1024, 576,  field_mode::progressive,	25000,		1000,	boost::assign::list_of(1920),							L"576p2500"),
	...
	DEFINE_VIDEOFORMATDESC(video_format::x720p2400	,1280, 720,  1280, 720,  field_mode::progressive,	24000,		1000,	boost::assign::list_of(2000),							L"720p2400"),
	DEFINE_VIDEOFORMATDESC(video_format::x720p2500	,1280, 720,  1280, 720,  field_mode::progressive,	25000,		1000,	boost::assign::list_of(1920),							L"720p2500"), 
	DEFINE_VIDEOFORMATDESC(video_format::x720p5000	,1280, 720,  1280, 720,  field_mode::progressive,	50000,		1000,	boost::assign::list_of(960),							L"720p5000"), 
	...
	DEFINE_VIDEOFORMATDESC(video_format::x720p3000	,1280, 720,  1280, 720,  field_mode::progressive,	30000,		1000,	boost::assign::list_of(1600),							L"720p3000"),
	DEFINE_VIDEOFORMATDESC(video_format::x720p6000	,1280, 720,  1280, 720,  field_mode::progressive,	60000,		1000,	boost::assign::list_of(800),							L"720p6000"),
	...
	DEFINE_VIDEOFORMATDESC(video_format::x1080p2400	,1920, 1080, 1920, 1080, field_mode::progressive,	24000,		1000,	boost::assign::list_of(2000),							L"1080p2400"),
	DEFINE_VIDEOFORMATDESC(video_format::x1080i5000	,1920, 1080, 1920, 1080, field_mode::upper,			25000,		1000,	boost::assign::list_of(1920),							L"1080i5000"),
	...
	DEFINE_VIDEOFORMATDESC(video_format::x1080i6000	,1920, 1080, 1920, 1080, field_mode::upper,			30000,		1000,	boost::assign::list_of(1600),							L"1080i6000"),
	DEFINE_VIDEOFORMATDESC(video_format::x1080p2500	,1920, 1080, 1920, 1080, field_mode::progressive,	25000,		1000,	boost::assign::list_of(1920),							L"1080p2500"),
	...
	DEFINE_VIDEOFORMATDESC(video_format::x1080p3000	,1920, 1080, 1920, 1080, field_mode::progressive,	30000,		1000,	boost::assign::list_of(1600),							L"1080p3000"),
	DEFINE_VIDEOFORMATDESC(video_format::x1080p5000	,1920, 1080, 1920, 1080, field_mode::progressive,	50000,		1000,	boost::assign::list_of(960),							L"1080p5000"),
	...
	DEFINE_VIDEOFORMATDESC(video_format::x1080p6000	,1920, 1080, 1920, 1080, field_mode::progressive,	60000,		1000,	boost::assign::list_of(800),							L"1080p6000"),
	...
	DEFINE_VIDEOFORMATDESC(video_format::x1556p2400	,2048, 1556, 2048, 1556, field_mode::progressive,	24000,		1000,	boost::assign::list_of(2000),							L"1556p2400"),
	DEFINE_VIDEOFORMATDESC(video_format::x1556p2500	,2048, 1556, 2048, 1556, field_mode::progressive,	25000,		1000,	boost::assign::list_of(1920),							L"1556p2500"),
	...
	DEFINE_VIDEOFORMATDESC(video_format::x2160p2400	,3840, 2160, 3840, 2160, field_mode::progressive,	24000,		1000,	boost::assign::list_of(2000),							L"2160p2400"),
	DEFINE_VIDEOFORMATDESC(video_format::x2160p2500	,3840, 2160, 3840, 2160, field_mode::progressive,	25000,		1000,	boost::assign::list_of(1920),							L"2160p2500"),
