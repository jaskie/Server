...
public:	
	...
	explicit write_frame(const safe_ptr<ogl_device>& ogl, const void* tag, const core::video_format_desc& video_format, const core::pixel_format_desc& desc, const channel_layout& channel_layout, int timecode);
